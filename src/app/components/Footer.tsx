...
export const Foot = () => {
    ...
    <footer className="bg-white dark:bg-gray-900">
        ...
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">E-COMMERCE</h2>
                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                    <li className="mb-4">
                        <a href="" className=" hover:underline">Got Question? Call us 24/7</a>
                    </li>
                    <li className="mb-4">
                        <a href="" className="hover:underline">+020554156</a>
                    </li>
                    <li className="mb-4">
                        <a href="" className="hover:underline"><p>Register now & get you 10% offer from first order!</p></a>
                    </li>
                </ul>
            ...
            <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                    ...
                    <li className="mb-4">
                        <a href="" className="hover:underline">Order History</a>
                    </li>
                </ul>
            </div>
            <div>
            ...
            <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                    ...
                    <li className="mb-4">
                        <a href="" className="hover:underline">Money Return Policy</a>
                    </li>
                    <li className="mb-4">
                        <a href="" className="hover:underline">Product Return</a>
                    </li>
                    <li className="mb-4">
                        <a href="" className="hover:underline">Contact Seller</a>
                    </li>
                    <li className="mb-4">
