...
const CardView: React.FC<{ data: any[], addToCart: (product: any) => void }> = ({ data, addToCart }) => {
  return (
    <ul className="grid grid-cols-3 gap-4 items-center">
      {data.map((item: any, index: number) => (
        <li key={index} className="w-full">
          <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow h-full flex flex-col">
